...
module.exports = function(){
    ...
    winston.add(new winston.transports.MongoDB({ db: `mongodb+srv://${config.get('dbUser')}:${config.get('dbPassword')}@cluster0-jmome.mongodb.net/${config.get('db')}`, options:{ useUnifiedTopology: true },level: 'error'}));
